...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <!-- get path to .widget file -->
  <xsl:template name="get-widget-file">
    ...
    <xsl:value-of select="concat($basepath,$widgetPath,$elpathdelimiter,'meta',$elpathdelimiter,$widgetName,'.widget')"></xsl:value-of>
  </xsl:template>

  <!-- get widget name out of fully qualified name -->
